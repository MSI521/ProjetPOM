...
public class PageHome {
    ...
    public WebElement txt_nom_du_profil;
    ...
    public void Cliquer_sur_bt_signlogin() {
		...
		public void sasir_le_mail_mot_de_passe(String mail , String mot_de_passe) {
			login_mail.sendKeys(mail);
			login_password.sendKeys(mot_de_passe);
		...
		public String profilaffiche() {
			String profil_obtenu = txt_nom_du_profil.getText();
